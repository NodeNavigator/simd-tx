module github.com/jaybxyz/simd-tx
...
require (
	...
	github.com/tradeview-local/tradeview-chain v1.0.1
...
replace (
	...
	github.com/tradeview-local/tradeview-chain => ../../../tradeviewFolder/tradeview-chain
)
